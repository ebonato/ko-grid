...
;(function(factory) {
    if (typeof define === 'function' && define['amd'])
        define(['require', 'knockout', 'ko-data-source', 'ko-indexed-repeat'], factory);
    else
        window['ko-grid'] = factory(function (configName, handler) {
 ...
 * License: BSD 3-clause (http://opensource.org/licenses/BSD-3-Clause)
 */
var onefold_js, onefold_dom, ko_grid_application_event_dispatcher, ko_grid_template, text, text_ko_grid_columnshtmltemplate, ko_grid_columns, stringifyable, text_ko_grid_datahtmltemplate, ko_grid_data, text_ko_grid_headershtmltemplate, ko_grid_headers, ko_grid_layout, ko_grid_core, ko_grid_extensions, text_ko_grid_gridhtmltemplate, ko_grid_binding, ko_grid;
onefold_js = function () {
